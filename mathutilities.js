...
var smoothstep = function (low, high, x) {
    x = clamp((x - low) / (high - low), 0.0, 1.0);
    return x * x * (3 - 2 * x);
};

var addVectors = function (out, a, b) {
    out[0] = a[0] + b[0];
    out[1] = a[1] + b[1];
    out[2] = a[2] + b[2];
    return out;
...
var subtractVectors = function (out, a, b) {
    out[0] = a[0] - b[0];
    out[1] = a[1] - b[1];
    out[2] = a[2] - b[2];
    return out;
...
var squaredMagnitudeOfVector = function (v) {
    return v[0] * v[0] + v[1] * v[1] + v[2] * v[2];
};

var magnitudeOfVector = function (v) {
...
var divideVectorByScalar = function (out, v, k) {
    out[0] = v[0] / k;
    out[1] = v[1] / k;
    out[2] = v[2] / k;
    return out;
...
var crossVectors = function (out, a, b) {
...
var transformVecByMat3 = function(out, m, a) {
...
var transposeMat4 = function (out, a) {
...
var makePerspectiveMatrix = function (out, fovy, aspect, near, far) {
